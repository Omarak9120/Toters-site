...
const careers = {"title":"Careers at Toters","subtitle":"Join us in making it easy to get anything you need.","applyCta":"Apply via Email","email":"jobs@totersapp.com","benefits":[{"title":"Impact","desc":"Ship features used across the region."},{"title":"Growth","desc":"Mentorship, learning budget, and clear paths."},{"title":"Flexibility","desc":"Hybrid work with Beirut HQ."},{"title":"Ownership","desc":"Take big swings—own your domain."}]};
